...
export const metadata: Metadata = {
  ...
  description:
    'Expert integrative veterinary care for cats, dogs and senior pets. Home visits and remote consultations across the UK. DVM MRCVS CertAVP ISFMAdvCerFB.',
  keywords: [
    'integrative vet UK',
    'feline behaviour expert UK',
    'home visit vet London',
    'online vet consultation UK',
    'cat pain management',
    'palliative pet care UK',

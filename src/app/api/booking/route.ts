...
import { z } from 'zod'
import { SHARED_PAYMENT_MESSAGE, formatServiceTypeLabel } from '@/lib/serviceCatalog'
...
export async function POST(req: NextRequest) {
  try {
    ...
    const serviceLabel = formatServiceTypeLabel(data.serviceType)
      ...
      .sendMail({
        ...
        <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px;border:1px solid #eee;border-radius:12px">
          ...
          <p style="color:#444;line-height:1.7">
            We've received your enquiry for <strong>${serviceLabel}</strong>.
          </p>
          ...
          <p style="color:#444;line-height:1.7">
            If you have urgent concerns, please contact your nearest emergency veterinary clinic directly.
          </p>
